...
easy_quiz = "Mercedes-Benz is a global __1__ manufacturer and a division of the German company __2__ AG. The brand is known for luxury vehicles, buses, coaches, and trucks. The headquarters of __3__-Benz are in __4__, Baden-Wuerttemberg, Germany."
...
def level():
    level_feedback = ""
    while level_feedback!=level_index_list[0] and level_feedback!=level_index_list[1] and level_feedback!=level_index_list[2]:
...
def check_answer (user_answer, answer_list, session_answer): #user_answer kommt von quiz_session user_input
...
# management through the active quiz_session
def quiz_session(quiz, answer_list):
    print
    print "Here is your " + level_feedback.upper() +" quiz:"
    print "--------------------"
    print quiz
    session_answer = [] # session_answer is needed for filtering out answer duplicates
    count_wrong = 0
    count_right = 0
    while count_right <= len(answer_list):
       ...
       if  result_check_answer != None:
           ...
           print
           print "Great Job! '" + user_answer + "' is correct! " + str(count_wrong)+ " / " + str(max_wrong) + " wrong Answers"
           print "--------------------"
           print quiz
           count_right += 1
           ...
           count_wrong += 1
           print "Answer '" + user_answer + "' was not correct. Try again! " + str(count_wrong)+ " / " + str(max_wrong) + " wrong answers"
           print "--------------------"
           print quiz
